...
class UserAuthTest(django.test.TestCase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.email1 = "test@business.com"
        self.business_name = "test shop"
        self.username1 = "business"
        self.password1 = "1234"
        ...
        self.user1.save()
        Business.objects.create(user=self.user1, name=self.business_name)

        self.email2 = "test@customer.com"
        self.username2 = "customer"
        self.password2 = "1234"
    ...
    def test_logout(self):
        ...
        """
        logout_url = reverse("business:logout")
    ...
    def test_login_view_with_business(self):
        ...
        login_url = reverse("business:login")
    ...
    def test_login_view_with_customer(self):
        """A user can not log in using the login view with customer account."""
        login_url = reverse("business:login")
        response = self.client.get(login_url)
        self.assertEqual(200, response.status_code)
