...
class EntryModelTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.queue1 = Queue.objects.create(
            business=cls.business1, name="Small", prefix="A"
        )
        cls.queue2 = Queue.objects.create(
            business=cls.business2, name="Big", prefix="B"
        )
    ...
    def test_tracking_code_uniqueness_across_queues(self):
        ...
        entry1 = Entry.objects.create(
            name="Customer 1", queue=self.queue1, business=self.business1, time_out=None
        )
        entry2 = Entry.objects.create(
            name="Customer 2", queue=self.queue2, business=self.business2, time_out=None
        )
    ...
    def test_tracking_code_reset_after_time_out(self):
        ...
        entry = Entry.objects.create(
            name="Customer 3", queue=self.queue1, business=self.business1, time_out=None
        )
    ...
    def test_get_queue_before(self):
        ...
        entry1 = Entry.objects.create(
            name="Test Entry", queue=self.queue1, business=self.business1, time_in=today
        )
        entry2 = Entry.objects.create(
            name="Test Entry2",
            queue=self.queue1,
            business=self.business1,
            time_in=today + plus_time,
        )
