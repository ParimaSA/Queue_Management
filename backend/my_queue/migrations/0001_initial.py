# Generated by Django 5.1 on 2024-11-10 12:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('prefix', models.CharField(default='A', max_length=1)),
                ('estimated_time', models.IntegerField(blank=True, null=True)),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_queue.business')),
            ],
        ),
        migrations.CreateModel(
            name='Entry',
            fields=[
                ...
                ('business', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='my_queue.business')),
                ('queue', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='my_queue.queue')),
            ],
        ),
    ]
