          ...
          <div className="bg-white shadow-lg rounded-3xl p-6 md:p-14 lg:p-16 relative -translate-y-8 w-full max-w-5xl">
            ...
            <div className="mt-12 flex justify-center">
              <Link href="/business/login">
                <button className="w-60 lg:w-72 px-8 py-4 text-lg font-semibold rounded-full bg-gradient-to-r from-lightPurple to-lightPurple5 text-white shadow-md hover:scale-105 transform transition-all duration-300">
                  Start Now!
                </button>
              </Link>
            </div>
